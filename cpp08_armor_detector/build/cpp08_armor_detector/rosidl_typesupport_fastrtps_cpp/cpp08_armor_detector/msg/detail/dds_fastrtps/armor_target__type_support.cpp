...
#include "cpp08_armor_detector/msg/detail/armor_target__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp08_armor_detector::msg::ArmorTarget;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp08_armor_detector::msg::ArmorTarget *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp08_armor_detector::msg::ArmorTarget *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ArmorTarget__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cpp08_armor_detector::msg::ArmorTarget *>(
...
static size_t _ArmorTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ArmorTarget(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ArmorTarget__callbacks = {
...
static rosidl_message_type_support_t _ArmorTarget__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArmorTarget__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cpp08_armor_detector
const rosidl_message_type_support_t *
get_message_type_support_handle<cpp08_armor_detector::msg::ArmorTarget>()
{
  return &cpp08_armor_detector::msg::typesupport_fastrtps_cpp::_ArmorTarget__handle;
}
