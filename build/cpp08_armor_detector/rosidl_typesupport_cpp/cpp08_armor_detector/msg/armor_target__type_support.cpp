...
static const _ArmorTarget_type_support_symbol_names_t _ArmorTarget_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp08_armor_detector, msg, ArmorTarget)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp08_armor_detector, msg, ArmorTarget)),
  }
};
...
{
  return &::cpp08_armor_detector::msg::rosidl_typesupport_cpp::ArmorTarget_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cpp08_armor_detector, msg, ArmorTarget)() {
  return get_message_type_support_handle<cpp08_armor_detector::msg::ArmorTarget>();
}
