...
bool cpp08_armor_detector__msg__armor_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cpp08_armor_detector.msg._armor_target.ArmorTarget", full_classname_dest, 50) == 0);
  }
  cpp08_armor_detector__msg__ArmorTarget * ros_message = _ros_message;
  {  // header
  ...
  {  // filtered_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "filtered_yaw");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->filtered_yaw = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // center_x
...
{
  /* NOTE(esteve): Call constructor of ArmorTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cpp08_armor_detector.msg._armor_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmorTarget");
  ...
  {  // filtered_yaw
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->filtered_yaw);
    {
      int rc = PyObject_SetAttrString(_pymessage, "filtered_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
