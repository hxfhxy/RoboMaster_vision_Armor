...
static rosidl_typesupport_introspection_c__MessageMember cpp08_armor_detector__msg__ArmorTarget__rosidl_typesupport_introspection_c__ArmorTarget_message_member_array[7] = {
  {
    "is_detected",  // name
